...
/* We do not support C11 <threads.h>.  */
 {"bitAnd", (funct_t) bitAnd, (funct_t) test_bitAnd, 2, "| ~", 8, 10,
 ...
 {"bitCount", (funct_t) bitCount, (funct_t) test_bitCount, 1, "! ~ & ^ | + << >>", 40, 2,
  {{TMin, TMax},{TMin,TMax},{TMin,TMax}}},
 {"minusTwo", (funct_t) minusTwo, (funct_t) test_minusTwo, 0,
    "! ~ & ^ | + << >>", 2, 12,
  {{TMin, TMax},{TMin,TMax},{TMin,TMax}}},
 {"tmax", (funct_t) tmax, (funct_t) test_tmax, 0, "! ~ & ^ | + << >>", 6, 10,
  {{TMin, TMax},{TMin,TMax},{TMin,TMax}}},
 {"negate", (funct_t) negate, (funct_t) test_negate, 1,
    "! ~ & ^ | + << >>", 5, 8,
  {{TMin, TMax},{TMin,TMax},{TMin,TMax}}},
 {"times34", (funct_t) times34,
     (funct_t) test_times34, 1,
    "! ~ & ^ | + << >>", 6, 6,
  {{TMin,TMax},{TMin,TMax},{TMin,TMax}}},
